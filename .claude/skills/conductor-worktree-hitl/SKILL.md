...
meta:
  version: 0.0.11
_upstream_source: palladius-common-commands
_upstream_version: 0.0.11
---
...
4.  Attach a detailed summary using Git Notes:
    ...
    ```
5.  Mark the task status as `completed` in `metadata.json`. The Coordinator Agent will handle checking out the branch, validation, merging, and final pushing.
